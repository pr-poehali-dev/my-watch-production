...
const watches = [
  ...
  },
  {
    ...
    description: "Фирменная шкатулка из дерева. Часы в футляре из кварцевого стекла, планшет с видеоинформацией о часах и пластиковая карта. Молоточек LUXURUSS в комплекте.",
    price: "",
